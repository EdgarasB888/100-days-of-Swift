...
class ViewController: UITableViewController
{
    ...
    {
        let recommendationString = "Hi friend! Found this awesome new app called Project1! Check it Out!"
        
        let vc = UIActivityViewController(activityItems: [recommendationString], applicationActivities: [])
